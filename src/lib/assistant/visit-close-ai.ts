...
outcome: order_taken = commande prise; no_order = visite réalisée sans commande; follow_up = décision ou action à reprendre; information = visite de suivi/information sans action commerciale immédiate; other = autre cas explicite.
