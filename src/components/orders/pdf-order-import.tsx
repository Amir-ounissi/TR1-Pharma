...
function PdfOrderPreviewForm({ preview }: { preview: PdfOrderPreview }) {
  ...
  const [brandPharmacyId, setBrandPharmacyId] = useState(preview.pharmacy.selectedId || (preview.pharmacy.status === "matched" ? preview.pharmacy.candidates[0]?.id ?? "" : ""));
