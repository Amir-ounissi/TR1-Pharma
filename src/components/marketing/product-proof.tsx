...
const views = {
  manager: {
    ...
    title: "Les priorités du jour deviennent immédiatement actionnables.",
    image: "/marketing/manager-day.webp",
    alt: "Vue TR1 Manager avec priorités, tournée et actions rapides",
  },
  agent: {
    label: "Expérience Agent",
    title: "Chaque intervenant retrouve sa journée dans une vue terrain claire.",
  ...
  missions: {
    ...
    title: "Animations et formations sont suivies dans un même tableau opérationnel.",
...
export function ProductProof() {
  ...
  return <div className="overflow-hidden rounded-[1.4rem] border border-white/10 bg-[#102944] shadow-[0_36px_100px_rgba(0,0,0,.38)]">
    <div className="flex flex-col gap-5 border-b border-white/10 px-4 py-4 sm:px-6 lg:flex-row lg:items-center lg:justify-between">
    ...
    <div className="flex flex-col gap-3 px-5 py-5 text-white sm:flex-row sm:items-center sm:justify-between sm:px-7">
      <strong className="max-w-3xl text-lg tracking-[-.025em]">{view.title}</strong>
      <span className="shrink-0 font-mono text-[.62rem] uppercase tracking-[.12em] text-[#ff9d78]">Même réseau · Même scénario</span>
    </div>
  </div>;
}
