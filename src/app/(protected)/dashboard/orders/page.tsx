...
export default async function OrdersPage({ searchParams }: { searchParams: SearchParams }) {
  ...
  return <div className="space-y-6"><div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between"><div><h1 className="text-2xl font-semibold">Commandes</h1><p className="text-muted-foreground">Commandes, implantations, réassorts et avoirs de {brand.name}.</p></div><div className="flex gap-2"><Button asChild variant="outline"><Link href="/dashboard/imports">Importer un CSV</Link></Button><Button asChild><Link href="/dashboard/orders/new">Nouvelle commande</Link></Button></div></div>
