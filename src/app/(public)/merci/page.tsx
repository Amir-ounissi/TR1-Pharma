...
export default function ThankYouPage() {
  ...
  return (
    <main className="mx-auto grid min-h-[70vh] max-w-3xl place-items-center px-5 py-16 text-center">
      ...
      <div>
        <p className="font-mono text-xs font-bold uppercase tracking-[.18em] text-[#c9562d]">Demande reçue</p>
        <h1 className="mt-4 text-4xl font-black tracking-[-.055em] sm:text-5xl">Votre demande a bien été envoyée.</h1>
        <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-[#596574]">Merci pour votre intérêt pour TR1. Nous vous recontacterons pour convenir d’un créneau.</p>
        {bookingUrl ? (
