      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          <h1 className="max-w-2xl text-[2.8rem] font-black leading-[.95] tracking-[-.07em] text-[#0b1e32] sm:text-[4.4rem]">
            Connectez-vous à <span className="text-[#c84f24]">TR1</span>.
          </h1>
          <p className="max-w-xl text-base leading-7 text-[#667384] sm:text-lg">
            Retrouvez votre espace commercial, vos pharmacies et vos actions terrain dans une interface simple et sécurisée.
          </p>
        </div>
