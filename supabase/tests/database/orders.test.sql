...
select is((select count(*) from public.brand_pharmacy_distribution_snapshots where brand_pharmacy_id='00000000-0000-0000-0000-000000000412'),1::bigint,'same-day snapshot is updated instead of duplicated');
...
select public.create_order('00000000-0000-0000-0000-000000000416','{"external_order_id":"S4-WATCH","order_status":"invoiced","order_date":"2026-05-17T10:00:00Z"}','[{"product_id":"00000000-0000-0000-0000-000000000601","quantity":1,"unit_price_ht":10}]');
...
select public.create_order('00000000-0000-0000-0000-000000000417','{"external_order_id":"S4-RISK","order_status":"invoiced","order_date":"2026-05-02T10:00:00Z"}','[{"product_id":"00000000-0000-0000-0000-000000000601","quantity":1,"unit_price_ht":10}]');
...
select public.create_order('00000000-0000-0000-0000-000000000418','{"external_order_id":"S4-DORMANT","order_status":"invoiced","order_date":"2026-04-12T10:00:00Z"}','[{"product_id":"00000000-0000-0000-0000-000000000601","quantity":1,"unit_price_ht":10}]');
